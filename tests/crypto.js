...
const traaittCrypto = require('../')

describe('Core Cryptography', () => {
  it('Generate Random Keys', () => {
    const [err, keys] = traaittCrypto.generateKeys()
  ...
  it('Check Key - Public Key', () => {
    ...
    const isValid = traaittCrypto.checkKey(key)
  ...
  it('Secret Key to Public Key', () => {
    ...
    const [err, generatedKey] = traaittCrypto.secretKeyToPublicKey(key)

    assert(!err && generatedKey === '7849297236cd7c0d6c69a3c8c179c038d3c1c434735741bb3c8995c3c9d6f2ac')
  })

  it('Generate Key Derivation', () => {
    const [err, derivation] = traaittCrypto.generateKeyDerivation('3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94', '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909')

    assert(!err && derivation === '4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20')
  })

  it('Derive Public Key', () => {
    const [err, publicKey] = traaittCrypto.derivePublicKey('4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20', 2, '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418')

    assert(!err && publicKey === 'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d')
  })

  it('Underive Public Key: Ours', () => {
    const [err, publicKey] = traaittCrypto.underivePublicKey('4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20', 2, 'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d')

    assert(!err && publicKey === '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418')
  })

  it('Underive Public Key: Not Ours', () => {
    const [err, publicKey] = traaittCrypto.underivePublicKey('4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20', 0, 'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d')

    assert(!err && publicKey !== '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418')
  })

  it('Derive Secret Key', () => {
    const [err, secretKey] = traaittCrypto.deriveSecretKey('4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20', 2, 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b')

    assert(!err && secretKey === 'e52ece5717f01843e3accc4df651d669e339c31eb8059145e881faae19ad4a0e')
  })

  it('Generate Key Image', () => {
    const [err, keyImage] = traaittCrypto.generateKeyImage('bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d', 'e52ece5717f01843e3accc4df651d669e339c31eb8059145e881faae19ad4a0e')
  ...
  it('Generate Deterministic Subwallet #0', () => {
    const [err, spendKey] = traaittCrypto.generateDeterministicSubwalletKeys('dd0c02d3202634821b4d9d91b63d919725f5c3e97e803f3512e52fb0dc2aab0c', 0)
  ...
  it('Generate Deterministic Subwallet #1', () => {
    const [err, spendKey] = traaittCrypto.generateDeterministicSubwalletKeys('dd0c02d3202634821b4d9d91b63d919725f5c3e97e803f3512e52fb0dc2aab0c', 1)
  ...
  it('Generate Deterministic Subwallet #64', () => {
    const [err, spendKey] = traaittCrypto.generateDeterministicSubwalletKeys('dd0c02d3202634821b4d9d91b63d919725f5c3e97e803f3512e52fb0dc2aab0c', 64)
  ...
  it('Tree Hash', () => {
    ...
    const [err, treeHash] = traaittCrypto.tree_hash([
  ...
  it('Tree Branch', () => {
    ...
    const [err, treeBranch] = traaittCrypto.tree_branch([
      'b542df5b6e7f5f05275c98e7345884e2ac726aeeb07e03e44e0389eb86cd05f0',
      '1b606a3f4a07d6489a1bcd07697bd16696b61c8ae982f61a90160f4e52828a7f',
      'c9fae8425d8688dc236bcdbc42fdb42d376c6ec190501aa84b04a4b4cf1ee122',
      '871fcd6823f6a879bb3f33951c8e8e891d4043880b02dfa1bb3be498b50e7578'
...
describe('Hash Generation Methods', () => {
  ...
  algos.forEach((algo) => {
    it(algo.name, () => {
      const [err, hash] = traaittCrypto[algo.func](testdata)
